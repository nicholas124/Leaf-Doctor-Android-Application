...
class Classifier (assetManager: AssetManager, modelPath: String, labelPath: String, inputSize: Int) {
    ...
    //class that performs the recognition
    //returns the title which is the disease lable in this case and
    //confidence level which is the level of accuracy
    ...
    /*
    have an instance of Interpreter, then convert the preprocessed bitmap
    into ByteBuffer then create a method that will take an image as an argument
     and return a list of labels with assigned probabilities to them
     */
    ...
    //convert the bitmap into the Bytebuffer
    ...
    /**returns the result after a leaf is scanned */
